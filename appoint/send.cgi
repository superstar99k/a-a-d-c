...
$conf{'thanks'} = 'https://www.a-a-d-c.com/appointment/reserved/';

#08.設置者に届くメールの件名
$conf{'subject'} = 'お問い合わせメールフォームから';

#09.送信者に届くメールの件名
$conf{'res_subject'} = '【AADC】診療予約ありがとうございます';

#10.送信者に届くメールの本文
$conf{'res_body'} = <<'__res_body_eof__';
──────────────────────────────────────
当メールは、診療予約または矯正無料相談いただいた方に自動送信されます。
──────────────────────────────────────

この度は、アンチエイジングデンタルクリニック恵比寿のサイトをご利用いただき、
誠にありがとうございます。
メールフォームからのご予約は、仮予約とさせて頂いております。
メールを確認後当院から予約確認のご連絡をさせて頂いておりますが、
返信に最大３営業日かかることもございますので、
お急ぎの方はお電話にてご予約ください。

このメールにお心当たりのない方は、
大変お手数ですが【お問い合わせ先】までご連絡いただきますよう、
お願い申し上げます。
