...
$conf{'thanks'} = 'https://www.a-a-d-c.com/en/thanks/';

#08.設置者に届くメールの件名
$conf{'subject'} = 'From the contact email form';

#09.送信者に届くメールの件名
$conf{'res_subject'} = '[AADC] Thank you for your inquiry!';

#10.送信者に届くメールの本文
$conf{'res_body'} = <<'__res_body_eof__';
-------------------------------------------------------
Thank you for your inquiry.
This e-mail is　automatically sent to the person who got the inquiry.
-------------------------------------------------------

Thank you for looking  at the Anti-aging dental clinic Ebisu website.
the contents were our inquiry, we will contact you from the person in charge.
If there is no reply within a few days after the transmission,
very excuse me, please give me a call directly.

<Contact Us>
Please feel free to contact us
e-mail  info@a-a-d-c.com
phone 03-5459-3163

Anti-Aging Dental Clinic Ebisu
2F VANDA Bld. 1-4-1 Ebisu-nishi,Shibuya-ku,
